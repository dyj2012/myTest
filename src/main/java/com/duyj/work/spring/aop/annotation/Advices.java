...
public class Advices {
    ...
    @Pointcut("execution(* com.duyj.work.spring.aop.annotation.ServiceFlow.*(..))")
    public void flow() {
    }

    @Pointcut("execution(* com.duyj.work.spring.aop.annotation.ServiceFlow.*(..)) && args(param)")
    public void flowWithParam(String param) {
    }

    //通知
    @Before("execution(* com.duyj.work.spring.aop.annotation.ServiceFlow.*(..))")//切点
